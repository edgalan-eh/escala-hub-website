...
Uso: faixa "Operamos e estruturamos em" (monocromático off-white, opacidade 60–70%) e mega menu Canais. Marcas pertencem aos titulares; uso nominativo, sem endosso (ver docs/legal/termos.md §5).

| Marca | Arquivo | Fonte | Status |
|---|---|---|---|
| Mercado Livre | mercado-livre-logo-horizontal.svg (cor), **mercado-livre-mono-dark.svg** (faixa), mercado-livre-mark-mono-dark.svg (menu), mercado-livre-mono-light.svg (paper) | kit Metri Hub + mono gerado com máscara (elipse e contornos transparentes de verdade) | ok. Não aplicar filtro mono no colorido: o aperto de mãos some |
