...
```
Três ajustes na Home e no artboard "Em breve".

1. POP-UP DE COOKIES / LGPD: ao carregar, card fixo no canto inferior esquerdo (360px, surface, borda 1px, cantos 12px, sombra, entra com fade + translateY 12px após 1s). Ícone linear âmbar de cookie/escudo. Título Sora 16px: "Sua privacidade". Texto muted 14px: "Usamos cookies para melhorar sua experiência e medir o site. Você escolhe." Links mono pequenos: Política de Privacidade · Termos de Uso. Botões: [Aceitar] âmbar pequeno · [Só essenciais] secundário pequeno. Some após escolha (lembrar por 12 meses). Não bloqueia a página.
